  ...
  return (
    ...
    <Formik initialValues={initialValues} onSubmit={onSubmit}>
      <Form className='mt-20 px-10 py-6'>
        <FormikControl control='textarea' name='prompt' label='Prompt' placeholder='Generate a react developer resume sample with 2+ years of experience. Tech Stack React.js, Tailwind and Node.js'/>
        <div className=' button'>
          <button className='text-slate-200 font-blod uppercase text-sm ' type='submit'>Generate</button>
      </div>
