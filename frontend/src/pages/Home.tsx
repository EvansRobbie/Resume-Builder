...
//    console.log(isOpen)
  return (
    <div className='pt-20 flex'>
        ...
        <Link  to='/create-resume/certifications' className={navLinks('certifications')}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
        ...
        <div onClick={handleSidebar} className='text-slate-100 py-6 flex w-full justify-end pr-4 cursor-pointer'>
        {isOpen?  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
